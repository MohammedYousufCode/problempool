...
import { Heart, Zap, ArrowLeft, User, Star, Lock, Cpu } from 'lucide-react'
          ...
          {aiBuildVisible && aiBuildContent && (
            <div className="card page-enter" style={{ padding: 'clamp(1.25rem, 3vw, 2rem)', borderTop: '3px solid var(--color-primary)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                ...
                <span className="badge badge-primary" style={{ marginLeft: 'auto' }}>Powered by Llama 4 Scout</span>
              </div>
              <div style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text)', lineHeight: 1.8, whiteSpace: 'pre-wrap' }}>
                {aiBuildContent}
              </div>
            </div>
          )}
